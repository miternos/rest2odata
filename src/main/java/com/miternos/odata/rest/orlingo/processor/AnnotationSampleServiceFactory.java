 ...
 * under the License.
 ******************************************************************************/
package com.miternos.odata.rest.orlingo.processor;

import com.miternos.odata.rest.orlingo.core.CustomAnnotationServiceFactory;
...
public class AnnotationSampleServiceFactory extends ODataServiceFactory {
  ...
  private static class AnnotationInstances {
    final static String MODEL_PACKAGE = "com.miternos.odata.rest.olingo.model";
    final static ODataService ANNOTATION_ODATA_SERVICE;
    
    static {
      try {
        ANNOTATION_ODATA_SERVICE = CustomAnnotationServiceFactory.createAnnotationService(MODEL_PACKAGE);
  ...
  public ODataService createService(final ODataContext context) throws ODataException {
    ...
    ODataService svc =  AnnotationInstances.ANNOTATION_ODATA_SERVICE;
      //((DataSourceProcessor)svc.getProcessor().getContext())
  ...
  public static ODataService getOdataService(){
      return AnnotationInstances.ANNOTATION_ODATA_SERVICE;
  }
}
