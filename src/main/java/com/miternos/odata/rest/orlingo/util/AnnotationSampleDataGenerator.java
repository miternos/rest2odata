 ...
 * under the License.
 ******************************************************************************/
package com.miternos.odata.rest.orlingo.util;
...
public class AnnotationSampleDataGenerator {
  ...
  public void generateSampleData(String serviceUrl) {
    ...
    String locationOne = "{"
                         + "      \"LocationId\":\"ed44891b-9fdf-422c-9c1a-1cbd6e4e59b1\",\"Location\":\"The Netherlands\",\"LocationLevel1\":\"The Netherlands\",\"LocationLevel2\":\"- This Level -\",\"LocationLevel3\":\"- This Level -\",\"LocationLevel4\":\"- This Level -\",\"LocationLevel5\":\"- This Level -\",\"LocationLevel6\":\"- This Level -\",\"DeviceNetworkId\":\"17987527-b21b-40d9-beb0-ffd2e41d7b03\"\n"
                         + "    }";


    createEntity(serviceUrl + "/DimLocation", locationOne, usedFormat);
